...
export const {
  loginStart, loginSuccess, loginFailed, registerStart, registerSuccess, registerFailed, refreshStart, refreshSuccess, refreshFailed, logoutStart, logoutSuccess, logoutFailed
} = authSlice.actions;
